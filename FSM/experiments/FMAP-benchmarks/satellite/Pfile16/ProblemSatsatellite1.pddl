...
(:init (mySatellite satellite1)
 ...
 (not (on_board satellite1 instrument10))
 (not (on_board satellite1 instrument11))
 (not (on_board satellite1 instrument12))
 (not (on_board satellite1 instrument13))
 (not (on_board satellite1 instrument14))
 (not (on_board satellite1 instrument15))
