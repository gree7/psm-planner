...
(:init (mySatellite satellite6)
 ...
 (on_board satellite6 instrument16)
 ...
 (not (on_board satellite6 instrument13))
 (not (on_board satellite6 instrument17))
 (not (on_board satellite6 instrument18))
 (not (on_board satellite6 instrument19))
 (not (on_board satellite6 instrument20))
 (not (on_board satellite6 instrument21))
 (not (on_board satellite6 instrument22))
