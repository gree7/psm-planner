...
(:init (mySatellite satellite10)
 ...
 (on_board satellite10 instrument20)
 (on_board satellite10 instrument21)
 (on_board satellite10 instrument22)
 (not (on_board satellite10 instrument0))
 (not (on_board satellite10 instrument1))
 (not (on_board satellite10 instrument2))
 (not (on_board satellite10 instrument3))
 (not (on_board satellite10 instrument4))
 (not (on_board satellite10 instrument5))
 (not (on_board satellite10 instrument6))
 (not (on_board satellite10 instrument7))
 (not (on_board satellite10 instrument8))
 (not (on_board satellite10 instrument9))
 (not (on_board satellite10 instrument10))
 (not (on_board satellite10 instrument11))
 (not (on_board satellite10 instrument12))
 (not (on_board satellite10 instrument13))
 (not (on_board satellite10 instrument14))
 (not (on_board satellite10 instrument15))
 (not (on_board satellite10 instrument16))
 (not (on_board satellite10 instrument17))
 (not (on_board satellite10 instrument18))
 (not (on_board satellite10 instrument19))
 (not (on_board satellite10 instrument23))
