...
(:init (mySatellite satellite8)
 ...
 (on_board satellite8 instrument16)
 (on_board satellite8 instrument17)
 ...
 (not (on_board satellite8 instrument19))
 (not (on_board satellite8 instrument20))
 (not (on_board satellite8 instrument21))
 (not (on_board satellite8 instrument22))
 (not (on_board satellite8 instrument23))
