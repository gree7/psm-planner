...
(:init (mySatellite satellite3)
 ...
 (on_board satellite3 instrument10)
 (on_board satellite3 instrument11)
 ...
 (not (supports instrument12 thermograph0))
 (not (supports instrument12 thermograph2))
)
(:global-goal (and
