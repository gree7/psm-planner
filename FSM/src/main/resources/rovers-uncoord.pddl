...
(:action communicate_all_data
 ...
 :precondition (and (ready_soil_data ?r ?psoil) (ready_rock_data ?r ?prock) (ready_image_data ?r ?o ?m) (available ?r)
            )
 :effect (and (not (available ?r)) (communicated ?psoil ?prock ?o ?m) (available ?r)
    )
)
