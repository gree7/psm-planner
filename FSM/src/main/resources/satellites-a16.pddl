...
(:init
    ...
    (calibration_target instrument14 d29)
    (calibration_target instrument14 d30)
    (on_board instrument14 sat4)
    (power_avail sat4)
    (pointing sat4 d29)
    (supports instrument15 spectrograph7)
    (calibration_target instrument15 d31)
    (calibration_target instrument15 d32)
    (on_board instrument15 sat5)
    (power_avail sat5)
    (pointing sat5 d32)
)
(:goal (and
    ...
    (have_image d29 thermograph7)
    (have_image d31 spectrograph7)
))
